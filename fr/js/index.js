...
async function connecting() {
    ...
    div1.innerHTML = "Connexion à www.marcmeynet.ch";
    for (let i = 1; i < 16; i++)
    {
        div1.innerHTML += ".";
        if (!(i%5))
    ...
    div2.innerHTML = "Connexion réussite.";
    ...
    if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
      asyncTyper(document.getElementById("errorMsg"), "Bientôt disponible sur appareils mobiles..");
   } else {
